module ApplicationHelper
  def navbar(current_user)
    if current_user.nil?
      content_tag(:li, link_to('Log in | ', new_user_session_path, class: 'mr-2 simple-link')).html_safe
      content_tag(:li, link_to('Sign up', new_user_session_path, class: 'mr-2 simple-link')).html_safe
    else
